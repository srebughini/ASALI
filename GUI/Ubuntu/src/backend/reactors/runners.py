...
def run_steady_state_heterogeneous_reactor_model(cantera_input_file,
                                                      gas_phase_name,
                                                      surface_phase_name,
                                                      input_dict,
                                                      results) -> None:
    """
    Run SteadyStateHeterogeneous1DReactor model
    Parameters
    ----------
    cantera_input_file: str
        Cantera input file path
    ...
    -------
    """
    reactor_class = SteadyStateHeterogeneous1DReactor(cantera_input_file, gas_phase_name, surface_phase_name)
    unit_converter = UnitConverter()
    ...
    results.put({ReactorResultsFormat.results: (reactor_class.get_length(BasicUnitDimension.length.value),
                                                reactor_class.get_results(),
                                                None),
                 ReactorResultsFormat.reactor: SteadyStateHeterogeneous1DReactor})
