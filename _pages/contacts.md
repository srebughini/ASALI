...
<!--<div class="col-md-6 text-center">-->
  <form action="https://formspree.io/f/mdopzvpj" method="POST">
    <h3>Your email:</h3>
    <p>
      <input type="text" style="width:75%; border:solid " placeholder="your.email@example.com" name="_replyto">
    </p>
    <h3>Your message:</h3>
    <p>
      <textarea placeholder="Write something..." style="height:200px; width:75%; border:solid" name="message"></textarea>
    </p>
