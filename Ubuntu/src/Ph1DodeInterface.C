...
namespace ASALI
{
    Ph1DodeInterface::Ph1DodeInterface()
    {
        #include "Beer.H"
    ...
    void Ph1DodeInterface::setEquations(ASALI::Ph1DEquations* eq)
    {
        eq_  = eq;
    ...
    void Ph1DodeInterface::setBandDimensions(const double upperBand, const double lowerBand)
    {
        upperBand_ = upperBand;
        lowerBand_ = lowerBand;
    }
    
    void Ph1DodeInterface::setTollerance(const double absTol, const double relTol)
    {
        absTol_ = absTol;
        relTol_ = relTol;
    }
    
    void Ph1DodeInterface::setConstraints(const bool constraints)
    {
        constraints_ = constraints;
    }

    void Ph1DodeInterface::setInitialConditions(double t0, std::vector<double> y0)
    {
    ...
    int Ph1DodeInterface::solve(const double tf, std::vector<double>& yf)
    {
        int flag;
    ...
    int Ph1DodeInterface::checkFlag(void *flagvalue, const char *funcname, int opt)
    {
        /* 
    ...
    std::string Ph1DodeInterface::getBeer()
    {
        srand(time(NULL));
    ...
    Ph1DodeInterface::~Ph1DodeInterface(void)
    {
