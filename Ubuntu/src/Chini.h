...
namespace ASALI
{
    class Chini : public Gtk::Window
    {
        ...
        private:
            ...
            std::vector<Gtk::Label *>          vacuumVector_;
            ...
            ASALI::propertiesInterface  *propertiesInterface_;
            ASALI::speciesPopup         *speciesNames_;
            ASALI::Properties           *properties_;
